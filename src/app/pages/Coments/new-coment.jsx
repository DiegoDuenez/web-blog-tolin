        ...
        <div className="div-form-new-coment">
            <Form>
                <Form.Field>
                    ...
                    <input onChange={(e) => set_id_post(e.target.value)} placeholder='Comentario'/>
                    <input onChange={(e) => set_id_user(e.target.value)} placeholder='Comentario'/>

                </Form.Field>


                <div className="div-btn-comentario">
                    <Button onClick={postData} className="btn-comentario" type="submit">Añadir Comentario</Button>
                </div>
            </Form>
        </div>
    )
